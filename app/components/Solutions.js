  ...
  return (
    <section id="solutions" className="py-32 bg-light  max-md:py-5 overflow-hidden">
      <div className="container px-4 mx-auto flex">
        ...
        ">
          {/* 左 */}
          <div className="lg:w-6/12 relative mb-10 lg:mb-0 z-10 before:content-[' '] before:absolute before:right-1/2 before:w-screen before:rounded-tr-[200px] before:z-[-1] before:rounded-br-3xl before:py-28 before:-top-20 before:bg-white before:-bottom-20
          max-md:mt-28
          ">
            <div className="flex gap-2">
              ...
              <div className="mt-auto">
                <div className="flex flex-col gap-2">
                  <div>
                    <div className="bg-purpleLight w-10 h-10 lg:w-20 lg:h-20 rounded-2xl rounded-tr-[200px]
